...
class Compass {
    ...
    companion object {
        ...
        private fun filterEventsForDate(icsData: String, date: LocalDate, timezone: Int): String {
        ...
        private fun isEventForDate(eventData: String, date: LocalDate, timeZoneOffset: Int): Boolean {
            ...
            val eventDateTime = LocalDateTime.of(year, month, day, hour, 0) // Assuming the time is in UTC
